...
RECORD_DATE="*/1 * * * * root date >> /home/$HIVE_ID/record.log"
...
MAIN_DATE="*/1 * * * * root date >> /home/$HIVE_ID/main.log"
MAIN="*/1 * * * * root python2 /home/$HIVE_ID/bee_sound/main.py >> /home/$HIVE_ID/main.log 2>&1"
...
sudo echo "$CHMOD_SOUND" >> /etc/crontab
