...
def learn_and_classify(X_train, y_train, X_test, y_test, genre_list):
	...
	joblib.dump(logistic_classifier, 'saved_models/model_mfcc_log_1_without_log.pkl')
	...
	print("knn_cm:") 
	print(knn_cm)
	joblib.dump(knn_classifier, 'saved_models/model_mfcc_log_1_without_knn.pkl')
...
def main():
	...
	"""
	genre_list = [ "general","queenless","virus"]
