	...
	for f in myfiles:
		...
		if f == 'general':
			...
			for g in general_list:
				...
				elif predicted_genre == "queenless":
					g3=g2[0].split("_")
					g4=g3[0]+"/"+g3[1]+"/"+g3[2]+" "+g3[3]+":"+g3[4]+":"+g3[5]
					ws.append([g4])
					wb.save('1_without_knn_test_queenless_error_real.xlsx')
			...
			print("general_w_queenless_num:"+str(general_w_queenloss_num))
			...
			print("virus_w_queenless_num:"+str(virus_w_queenloss_num))
